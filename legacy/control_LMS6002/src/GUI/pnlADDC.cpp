...
void pnlADDC::BuildContent(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	cmbBandgapTemp = new wxComboBox(this, ID_COMBOBOX1, wxEmptyString, wxDefaultPosition, wxSize(110,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX1"));
	FlexGridSizer2->Add(cmbBandgapTemp, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbBandgapGain = new wxComboBox(this, ID_COMBOBOX2, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX2"));
	FlexGridSizer2->Add(cmbBandgapGain, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefAmpsBiasAdj = new wxComboBox(this, ID_COMBOBOX3, wxEmptyString, wxDefaultPosition, wxSize(90,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX3"));
	FlexGridSizer2->Add(cmbRefAmpsBiasAdj, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefAmpsBiasUp = new wxComboBox(this, ID_COMBOBOX4, wxEmptyString, wxDefaultPosition, wxSize(90,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX4"));
	FlexGridSizer2->Add(cmbRefAmpsBiasUp, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefAmpsBiasDn = new wxComboBox(this, ID_COMBOBOX5, wxEmptyString, wxDefaultPosition, wxSize(95,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX5"));
	...
	cmbDACFullScaleOutputCurrent = new wxComboBox(this, ID_COMBOBOX16, wxEmptyString, wxDefaultPosition, wxSize(163,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX16"));
	...
	cmbRefResistorBiasAdj = new wxComboBox(this, ID_COMBOBOX6, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX6"));
	FlexGridSizer3->Add(cmbRefResistorBiasAdj, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefBiasUp = new wxComboBox(this, ID_COMBOBOX7, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX7"));
	FlexGridSizer3->Add(cmbRefBiasUp, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefBiasDn = new wxComboBox(this, ID_COMBOBOX8, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX8"));
	FlexGridSizer3->Add(cmbRefBiasDn, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefBufferBoost = new wxComboBox(this, ID_COMBOBOX9, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX9"));
	FlexGridSizer3->Add(cmbRefBufferBoost, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbCoomonModeAdj = new wxComboBox(this, ID_COMBOBOX10, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX10"));
	FlexGridSizer3->Add(cmbCoomonModeAdj, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbRefGainAdj = new wxComboBox(this, ID_COMBOBOX11, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX11"));
	...
	cmbMainBiasDN = new wxComboBox(this, ID_COMBOBOX12, wxEmptyString, wxDefaultPosition, wxSize(80,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX12"));
	FlexGridSizer4->Add(cmbMainBiasDN, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbClockNonOverlapAdjust = new wxComboBox(this, ID_COMBOBOX13, wxEmptyString, wxDefaultPosition, wxSize(120,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX13"));
	FlexGridSizer4->Add(cmbClockNonOverlapAdjust, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	cmbADCSamplingPhase = new wxComboBox(this, ID_COMBOBOX14, wxEmptyString, wxDefaultPosition, wxSize(116,-1), 0, 0, 0, wxDefaultValidator, _T("ID_COMBOBOX14"));
	...
	Connect(ID_CHECKBOX1,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&pnlADDC::OnchbEN_ADC_DACClick);
...
void pnlADDC::OnchbEN_ADC_DACClick(wxCommandEvent& event)
{
    if(sendChanges) LMLL_ADDCSetEN_ADC_DAC(chbEN_ADC_DAC->GetValue());
}
